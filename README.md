...
El servidor debe llevar el control de la partida de parqués y la implementación de las reglas fundamentales. Para esto, en los archivos [server_adapter.py](server_side/server_adapter.py) y [game_engine.py](server_side/game_engine.py) se proponen un conjunto de acciones y funciones que pueden ser ajustadas o complementadas por parte del equipo de trabajo.
